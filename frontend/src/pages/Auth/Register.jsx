            ...
            <div className="mr-[4rem] mt-[5rem]">
                ...
                <form onSubmit={submitHandler}
                    ...
                    <div className="my-[2rem]">
                        ...
                        <input type="text" id="name" className="mt-1 p-2 border rounded w-full" placeholder="Enter name"
                            value={username}
                            onChange={
                    ...
                    <div className="my-[2rem]">
                        ...
                        <input type="password" id="confirmPassword" className="mt-1 p-2 border rounded w-full" placeholder="Confirm password"
